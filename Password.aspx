<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Password.aspx.cs" Inherits="EMS.Password" %>
        ...
        <table align="center" class="auto-style5">
            <tr>
                <td class="auto-style10" colspan="3">
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblLinkError" runat="server" ForeColor="Red"></asp:Label>
                </td>
            </tr>
            <tr>
                ...
                <td class="auto-style13">
                    <asp:RequiredFieldValidator ID="rfvLoginUsername" runat="server" ControlToValidate="txtPass" ErrorMessage="Username required." ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style18">
                    <asp:Button ID="btnNewPass" runat="server" OnClick="btnNewPass_Click" Text="Set Password" />
                </td>
